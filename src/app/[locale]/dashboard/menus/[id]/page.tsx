  ...
  const fetchMenuData = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setStats({
          totalItems: data.data?.itemsCount || data.itemsCount || 0,
          activeItems: data.data?.activeItemsCount || data.activeItemsCount || 0,
          categories: data.data?.categoriesCount || data.categoriesCount || 0,
          views: data.data?.views || data.views || 0,
        });
      }
    } catch (error) {
