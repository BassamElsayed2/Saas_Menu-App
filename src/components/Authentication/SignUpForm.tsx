          ...
          <div className="bg-white/90 dark:bg-[#0c1427]/90 backdrop-blur-xl border border-gray-200/50 dark:border-primary-500/10 rounded-2xl shadow-2xl dark:shadow-primary-500/5 p-8 md:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-start gap-3">
                ...
                <label 
                  className="text-sm cursor-pointer text-gray-500 dark:text-gray-400 leading-relaxed"
                  onClick={() => setAgreeTerms(!agreeTerms)}
                >
                  {t("agreeTerms")}{" "}
                  <Link href={`/${locale}/terms`} className="text-primary-500 dark:text-primary-400 hover:underline font-medium">
                    {t("termsOfService")}
                  </Link>{" "}
                  {t("and")}{" "}
                  <Link href={`/${locale}/privacy`} className="text-primary-500 dark:text-primary-400 hover:underline font-medium">
                    {t("privacyPolicy")}
                  </Link>
                </label>
              </div>
